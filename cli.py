...
class HermesCLI:
    ...
    def _get_status_bar_snapshot(self) -> Dict[str, Any]:
        ...
        # Cursor SDK reports billing-oriented token counts, not Hermes-style
        # context-window occupancy — hide the meter to avoid misleading values.
        if getattr(agent, "api_mode", None) != "cursor_sdk_runtime":
